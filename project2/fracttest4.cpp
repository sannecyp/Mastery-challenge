...
{
	rational sum;
        sum.num=(num*fract2.denom+fract2.num*denom);
        sum.denom=denom*fract2.denom;
...
{
	rational difference;
        difference.num=(num*fract2.denom-fract2.num*denom);
        difference.denom=denom*fract2.denom;
...
{
	rational division;
        division.num=num*fract2.denom;
        division.denom=denom*fract2.num;
...
{
	rational product;
	product.num=num*fract2.num;
	product.denom=denom*fract2.denom;
